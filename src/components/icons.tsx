...
export const PauseIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <>
      <path
        d="M16 12V36"
    ...
    { width: 48, height: 48, mirror: true },
  ),
);
export const PlayIcon = React.memo(({ theme }: { theme: Theme }) =>
  createIcon(
    <path
      d="M15 24V11.8756L25.5 17.9378L36 24L25.5 30.0622L15 36.1244V24Z"
      fill={iconFillColor(theme)}
      stroke={handlerColor(theme)}
      strokeWidth="4"
      strokeLinejoin="round"
    />,
    { width: 48, height: 48 },
